function storeCoords(name){
    if(name == "Brew've Been Served"){
        return [24.90443, 36.05626] // correct
    }
    
    if(name == 'Hallowed Grounds'){
        return [24.88518, 36.06323] //correct
    }

    if(name == 'Coffee Cameleon'){
        return [24.89133, 36.05539] //correct
    }

    if(name == 'Abila Airport'){
        return [24.82803, 36.05294] //correct
    }

    if(name == "Kronos Pipe and Irrigation"){
        return [24.89431, 36.08903] //cant find!!!
    }
    ...
    if(name == "Maximum Iron and Steel"){
        return [24.83694, 36.06492] //correct
    }
    ...
    if(name == "Carlyle Chemical Inc."){
        return [24.88316, 36.05989] //correct
    }

    if(name == "Coffee Shack"){
        return [24.85988, 36.07415] //correct
    }
    ...
    if(name == "Jack's Magical Beans"){
        return [24.87335, 36.06900] //correct
    }

    if(name == "Katerina�s Caf�"){
        return [24.89980, 36.05444] //correct
    }
    ...
    if(name == "Gelatogalore"){
        return [24.86285, 36.06088] //correct
    }
    ...
    if(name == "Ouzeri Elian"){
        return [24.87285, 36.05583]//correct
    }

    if(name == "Guy's Gyros"){
        return [24.90000, 36.05989]//correct
    }

    if(name == "U-Pump"){
        return [24.86770, 36.06999] //correct
    }

    if(name == "Frydos Autosupply n' More"){
        return [24.90653, 36.06058] //correct
    }
    ...
    if(name == "Abila Scrapyard"){
        return [24.84552, 36.07584] //correct
    }

    if(name == "Frank's Fuel"){
        return [24.83888, 36.07316] //correct
    }

    if(name == "Chostus Hotel"){
        return [24.89514, 36.07346] //correct
    }

    if(name == "General Grocer"){
        return [24.85780, 36.06098] //correct
    }
    ...
    if(name == "Desafio Golf Course"){
        return [24.86741, 36.09079] //correct
    }
